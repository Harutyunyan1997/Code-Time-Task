...
if (siteProduct) {
  ...
  if (response.country == 'Россия') {
    document.getElementsByClassName('terretory')[0].innerHTML=response.city + "а";
  }else{
    document.getElementsByClassName('terretory')[0].innerHTML="Странах СНГ";
  }
 ...
 if (siteProduct.demonPopup) {
    ...
    $('head').append('<link rel="stylesheet" href="css/another/generator.css">');
    $('body').append('<div class="demon_popup">\n' +
      ...
      '            <img src="img/sprites/png/prod1.png" alt="" style="width:28%">\n' +
